...
var PhaserDude = module.exports = function (game, id, weapon) {
  Phaser.Group.call(this, game, game.world, 'PhaserDude', false, true, Phaser.Physics.P2JS)
...
PhaserDude.prototype.update = function () {
  ...
  if (this.controls.jump && this.checkIfCanJump()) {
    this.sprite.body.moveUp(350)
...
PhaserDude.prototype.checkIfCanJump = function () {
