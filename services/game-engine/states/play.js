...
Play.prototype.preload = function() {
  // game.on('player-join', this._onPlayerJoin)
  // game.on('player-leave', this._onPlayerLeave)
  // game.on('player-update', this._onPlayerUpdate)
  // game.on('sync', this._onSync)
}

Play.prototype.shutdown = function() {
  // game.off('play-join')
  // game.off('play-leave')
  // game.off('play-update')
  // game.off('sync')
}
